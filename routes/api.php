...
Route::middleware('auth:api', 'user')->post('userstatistics', 'StatisticControllerAPI@getUserStatistics');

//___ All User Statistics ___________________
Route::middleware('auth:api', 'admin')->post('allusersstatistics', 'UserControllerAPI@getUsersStatistics');
...
Route::middleware('auth:api', 'admin')->post('users', 'UserControllerAPI@getUsers');

//___ Get Total Games Per Day ______________
Route::middleware('auth:api', 'admin')->post('totalgamesperdate', 'StatisticControllerAPI@getTotalGamesPerDate');
...
Route::middleware('auth:api', 'user')->post('/user/update', 'UserControllerAPI@update');

//___ Delete User Account __________________
Route::middleware('auth:api', 'user')->delete('/user/deleteaccount', 'UserControllerAPI@deleteAccount');
